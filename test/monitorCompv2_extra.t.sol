...
contract MonitorTest is Test {
    ...
    address constant COMPTROLLER_ADDRESS = 0x3d9819210A31b4961b30EF54bE2aeD79B9c9Cd3B; // Compound Comptroller on Ethereum Mainnet
    address constant CETH_ADDRESS = 0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5; // cETH on Ethereum Mainnet
    address constant WETH_GAS_TOKEN = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // WETH on Mainnet
    address constant ROUTER_ADDRESS = 0x80226fc0Ee2b096224EeAc085Bb9a8cba1146f7D; //ETH Mainnet Router Address
    uint64 constant CHAIN_SELECTOR_ARBITRUM = 4949039107694359620;    //Chain selector Arbitrum Mainnet
    address public constant DAI_ADDRESS = 0x6B175474E89094C44Da98b954EedeAC495271d0F; //DAI address Ethereum Mainnet
    address public constant CDAI_ADDRESS = 0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643; // cDai address Ethereum Mainnet
    ...
    function setUp() public {
        ...
        uint256 wethBalance = IERC20(WETH_GAS_TOKEN).balanceOf(address(monitor));
    ...
    function testMonitorLiquidationn() public {
        ...
        console.log("User minted cETH balance ", IERC20(CETH_ADDRESS).balanceOf(user));
        ...
        (, uint256 liquidity, ) = IComptroller(COMPTROLLER_ADDRESS).getAccountLiquidity(user);
        assert(liquidity > 0);
