...
//         bool transferSuccess = IERC20(aWethAddress).transfer(
//             address(vault),
//             withdrawAmount
//         );
...
//         uint256 vaultAweBalance = IERC20(aWethAddress).balanceOf(
//             address(vault)
//         );
...
//             vaultAweBalance,
//             withdrawAmount,
//             "Vault's aWETH balance mismatch"
//         );
...
//             wethBalance,
//             withdrawAmount,
//             "WETH balance mismatch in vault after withdrawal"
//         );
...
//             userEthBalance,
//             withdrawAmount,
//             "ETH balance mismatch after withdrawal"
//         );
//         vm.stopPrank();
//     }
// }
